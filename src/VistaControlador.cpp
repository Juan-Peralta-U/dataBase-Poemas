...
// --- Funciones del menú ---
void mostrarMenu(const string& titulo, const string opciones[],
                 int numOpciones) {
  string linea =
      "----------------------------------------------------------------";
  cout << linea << endl;
  ...
  switch (menu) {
    case 1:  // Obras
             ...
             Datos de la obra poética.
                 ...
                 • Tipo de poesía: décima, soneto, himno, haiku, romance, octava real,
             lira,        verso libre.
           • ID del autor.
           • Listado de las ediciones
           • ID de la Editorial.
    ...
    case 5:
      switch (opcion) {
        case 1:
          cout << "Consulta avanzada 1." << endl;
          break;
        case 2:
          cout << "Consulta avanzada 2." << endl;
          break;
        case 3:
          cout << "Consulta avanzada 3." << endl;
          break;
        case 4:
          cout << "Consulta avanzada 4." << endl;
          break;
        case 5:
          cout << "Consulta avanzada 5." << endl;
          break;
        case 6:
          cout << "Volviendo al menu principal..." << endl;
          break;
...
void gestionarMenu(const string& titulo, const string opciones[],
...
void ejecutarVista() {
  string opcionesObras[] = {"Agregar una nueva obra",
                            "Consultar obras existentes",
                            "Modificar informacion de una obra",
                            "Eliminar una obra", "Volver al menu principal"};
  string opcionesEdiciones[] = {"Agregar edicion a una obra existente",
                                "Consultar ediciones por obra",
                                "Modificar datos de una edicion",
                                "Eliminar edicion", "Volver al menu principal"};
  string opcionesAutores[] = {"Agregar un nuevo autor",
                              "Consultar autores existentes",
                              "Modificar informacion de un autor",
                              "Eliminar un autor", "Volver al menu principal"};
  string opcionesEditoriales[] = {
      "Agregar una nueva editorial", "Consultar editoriales existentes",
      "Modificar informacion de una editorial", "Eliminar una editorial",
  ...
  do {
    ...
    switch (opcion) {
      // submenus
      case 1:
        gestionarMenu("Gestion de Obras Poeticas", opcionesObras, 5, 1);
        break;
      case 2:
        gestionarMenu("Gestion de Ediciones", opcionesEdiciones,
                      sizeof(opcionesEdiciones) / sizeof(opcionesEdiciones[0]),
                      2);
        break;
      case 3:
        gestionarMenu("Gestion de Autores", opcionesAutores,
                      sizeof(opcionesAutores) / sizeof(opcionesAutores[0]), 3);
        break;
      case 4:
        gestionarMenu(
            "Gestion de Editoriales", opcionesEditoriales,
            sizeof(opcionesEditoriales) / sizeof(opcionesEditoriales[0]), 4);
        break;
      case 5:
        gestionarMenu("Consultas Avanzadas", opcionesConsultas,
                      sizeof(opcionesConsultas) / sizeof(opcionesConsultas[0]),
                      5);
        break;
      case 6:
        cout << "Guardando cambios y saliendo del sistema..." << endl;
        break;
      default:
        cout << "Opcion no valida. Por favor, intenta de nuevo." << endl;
    }
