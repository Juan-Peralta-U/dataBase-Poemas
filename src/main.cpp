...
void ejecutarAccion(int menu, int opcion) {
    switch (menu) {
        ...
        case 5: // Consultas avanzadas 
            ...
            break;
        default: cout << "Menu no valido." << endl;
    }
}
...
int main() {
    ...
    do {
        ...
        cout << "1. Gestionar Obras Poeticas" << endl;
        cout << "2. Gestionar Ediciones" << endl;
        cout << "3. Gestionar Autores" << endl;
        cout << "4. Gestionar Editoriales" << endl;
        cout << "5. Realizar Consultas Avanzadas" << endl;
        cout << "6. Guardar cambios y salir del sistema" << endl;
        cout << linea1 << endl;

        cout << "Ingresa el numero de la opcion que deseas ejecutar: ";
        cin >> opcion;
